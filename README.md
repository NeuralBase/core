...
> Core AI infrastructure engine for model serving and pipeline orchestration - part of the [NeuralBase](https://github.com/NeuralBase) open-source ecosystem.
...
This repository contains the `core` component, which handles the core runtime responsibilities for NeuralBase.
...
```bash
git clone https://github.com/NeuralBase/core
cd core
go mod download
```
